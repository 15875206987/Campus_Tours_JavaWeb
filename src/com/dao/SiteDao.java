...
public class SiteDao extends BasicDao<Site> {
    public int addSite(String s, String basePath) throws Exception {
        Gson gson = new Gson();
        ...
        String baseURL = basePath + "Image\\site_photo\\" + site.category_id + "\\" + site.site_name + ".jpg";
        //写文件夹
        try {
    ...
    public int updateSite(String s,String basePath) throws Exception {
        Gson gson = new Gson();
        Site site = gson.fromJson(s,Site.class);
        String sql = "delete from sites where site_id = ?";
        update(sql,site.site_id);
        String site_picURL = "https://localhost:8443/SCUT_Tour_JavaWeb/Image/site_photo/" + site.category_id + "/" + site.site_name + ".jpg";
        String baseURL = basePath + "Image\\site_photo\\" + site.category_id + "\\" + site.site_name + ".jpg";
        //写文件夹
        try {
        ...
        //存数据库
        sql = "insert into sites(site_name,category_id,site_lng,site_lat,site_desc,site_picURL) values(?,?,?,?,?,?)";
        return update(sql,site.site_name,site.category_id,site.site_lng,site.site_lat,site.site_desc,site_picURL);
    }
}
